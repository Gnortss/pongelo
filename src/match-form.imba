...
tag match-form
	...
	def matchAdded e
		match_details = {
			...
			p1_wins: p1_wins, 							p2_wins: p2_wins,
			p1_rating: e.detail..p1_rating,			p2_rating: e.detail..p2_rating,
			p1_rating_diff: e.detail..p1_rating_diff,	p2_rating_diff: e.detail..p2_rating_diff
		}
		state = "done"
	...
	<self>
		...
		<form @submit.prevent.throttle(1000)=presentModal!>
			...
			<row>
				<button type="submit"> "Submit Match"
		if state !== ""
